  ...
  return (
    <div className="container" style={{ paddingTop: '40px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginTop: '30px' }}>
        ...
        {/* Card for Tire Sets Mileage */}
        <Link to="/tire-pressure/sets-mileage" style={{ textDecoration: 'none' }}>
          <div className="card" style={{ 
            height: '100%',
            cursor: 'pointer',
            transition: 'transform 0.2s, box-shadow 0.2s',
          ...
          >
            ...
            <div style={{ padding: '20px' }}>
              <p style={{ color: '#666', lineHeight: '1.6', marginBottom: '15px' }}>
                Prospetto utilizzo set di gomme: traccia i km percorsi da ciascun set per ogni evento.
              </p>
              <ul style={{ color: '#666', lineHeight: '1.8' }}>
                <li>Denominazione set per riga</li>
                <li>Colonne evento/data editabili (B-S)</li>
                <li>Totali automatici per riga</li>
                <li>Campo note per ogni set</li>
              </ul>
            </div>
          </div>
        </Link>
      ...
      <div className="card" style={{ marginTop: '30px', backgroundColor: '#e7f3ff' }}>
        ...
        <p style={{ lineHeight: '1.6' }}>
          Il modulo Tire Pressure Management è suddiviso in quattro sezioni principali:
        </p>
        <ul style={{ lineHeight: '1.8' }}>
          ...
          <li><strong>Tire Sets Mileage:</strong> Prospetto utilizzo set di gomme con calcolo automatico dei totali chilometri</li>
        </ul>
      </div>
    </div>
  );
