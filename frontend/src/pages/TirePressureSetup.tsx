            ...
            <div className="card" style={{ marginTop: '30px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ color: '#2c5282', fontWeight: 'bold', marginBottom: '10px' }}>
                            Compensazione pressioni
                        </div>
                        <img
                            src="/images/Compensations.jpg"
                            alt="Compensazioni Pressioni"
                            style={{ maxWidth: '100%', maxHeight: '180px', marginBottom: '10px' }}
                        />
                    </div>
                    ...
                    <div style={{
                        ...
                        <div style={{ color: '#2c5282', fontWeight: 'bold', marginBottom: '10px' }}>
                            Pressione pneumatici pioggia
                        </div>
                        <img
                            src="/images/RainTirePressure.jpg"
                            alt="Pressioni Pneumatico Pioggia"
                            style={{ maxWidth: '100%', maxHeight: '180px', marginBottom: '10px' }}
                        />
                    </div>
                    ...
                    <div style={{
                        ...
                        <div style={{ color: '#2c5282', fontWeight: 'bold', marginBottom: '10px' }}>
                            Circonferenza rotolamento Hankook
                        </div>
                        <img
                            src="/images/RollingCircumferenceHankook.jpg"
                            alt="Circonferenze Hankook"
                            style={{ maxWidth: '100%', maxHeight: '180px', marginBottom: '10px' }}
                        />
                    </div>
                </div>
                ...
                <div style={{ marginTop: '20px', padding: '15px', backgroundColor: '#fff3cd', borderRadius: '4px', border: '1px solid #ffc107' }}>
                    <p style={{ margin: 0, color: '#856404' }}>
                        <strong>Nota:</strong> Per visualizzare correttamente le immagini, assicurati che i file siano presenti nella cartella
                        <code style={{ backgroundColor: '#fff', padding: '2px 6px', borderRadius: '3px', marginLeft: '4px' }}>frontend/public/images/</code>
                        e che i nomi corrispondano ai percorsi specificati nei tag <code>&lt;img&gt;</code>.
                    </p>
                </div>
            </div>
        </div>
